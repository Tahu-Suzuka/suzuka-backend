...
const validateName = () => body('name').optional().notEmpty().withMessage('Nama tidak boleh kosong.');
const validateAddress = () => body('address').optional().notEmpty().withMessage('Alamat tidak boleh kosong.');
const validatePhone = () => body('phone').optional().notEmpty().withMessage('Nomor HP tidak boleh kosong.');
...
export const validateUpdateProfile = [
    ...
    body('password').not().exists().withMessage('Gunakan rute /change-password untuk mengubah password.')
];

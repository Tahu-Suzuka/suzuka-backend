...
const validateCode = () =>
  body('code')
    .notEmpty()
    .withMessage('Kode voucher tidak boleh kosong.')
    .isUppercase()
    .withMessage('Kode voucher harus menggunakan huruf kapital.')
    .not()
    .contains(' ')
    .withMessage('Kode voucher tidak boleh mengandung spasi.')
...
const validateType = () =>
  body('type')
    .notEmpty()
    .withMessage('Tipe voucher tidak boleh kosong.')
...
const validateValue = () =>
  body('value')
    .notEmpty()
    .withMessage('Nilai voucher tidak boleh kosong.')
    .isFloat({ min: 0 })
    .withMessage('Nilai voucher harus berupa angka positif.');

const validateMaxDiscount = () =>
  body('maxDiscount')
    .optional() // Tidak wajib
    .isFloat({ min: 0 })
    .withMessage('Nilai diskon maksimal harus berupa angka positif.');

const validateMinPurchase = () =>
  body('minPurchase')
    .notEmpty()
    .withMessage('Minimal pembelian tidak boleh kosong.')
    .isFloat({ min: 0 })
    .withMessage('Minimal pembelian harus berupa angka positif.');

const validateDates = () =>
  body('validUntil')
    .notEmpty()
    .withMessage('Tanggal kedaluwarsa tidak boleh kosong.')
    .isISO8601()
...
const validateUsageLimit = () =>
  body('usageLimit')
    .notEmpty()
    .withMessage('Batas penggunaan tidak boleh kosong.')
    .isInt({ min: 1 })
    .withMessage('Batas penggunaan minimal harus 1.');
...
export const validateCreateVoucher = [
  ...
  body('validFrom')
    .notEmpty()
    .withMessage('Tanggal mulai berlaku tidak boleh kosong.')
    .isISO8601()
    .withMessage('Format tanggal mulai berlaku tidak valid.'),
  validateDates(),
  validateUsageLimit(),
];
